...
CREATE TYPE "public"."financial_account_type" AS ENUM('bank', 'credit_card', 'e_wallet', 'cash', 'investment', 'other');--> statement-breakpoint
...
CREATE INDEX "financial_accounts_cursor_idx" ON "financial_accounts" USING btree ("user_id","created_at","id");--> statement-breakpoint
